...
describe('stream cipher', () => {
  ...
  it('chacha20poly1305', () => {
    ...
    const n = HEX('070000004041424344454647')
    const a = HEX('50515253c0c1c2c3c4c5c6c7')
    const p = UTF8("Ladies and Gentlemen of the class of '99: If I could offer you only one tip for the future, sunscreen would be it.")
    const c = HEX(
      'd31a8d34648e60db7b86afbc53ef7ec2a4aded51296e08fea9e2b5a736ee62d63dbea45e8ca9671282fafb69da92728b1a71de0a9e060b2905d6a5b67ecd3b3692ddbd7f2d778b8c9803aee328091b58fab324e4fad675945585808b4831d7bc3ff4def08e4b7a9de576d26586cec64b6116',
    )
    const t = HEX('1ae10b594f09e26a7e902ecbd0600691')

    const cipher = chacha20poly1305(k, n)
    expect(cipher.encrypt(p)).toMatchObject(c)
    expect(cipher.decrypt(c)).toMatchObject(p)
    expect(cipher.sign(c, a)).toMatchObject(t)
    expect(cipher.verify(t, c, a)).toBe(true)
  })
  // * Rabbit
  it('rabbit', () => {
    const k_0 = new U8(16)
