...
it('md5', () => {
  ...
  expect(md5(UTF8('f3166a3a404599d2046ed2aae479b37d54b51d2e85259c9e314042753be7d813')).to(HEX)).toMatchInlineSnapshot('"e1276aa683dc7adb38fd366744d037e5"')
})
// * SHA-1
it('sha1', () => {
  const _ = UTF8('')
...
function ptn(n: number) {
  const sample = new Uint8Array([
    ,
...
it('turboShake', () => {
  ...
  expect(turboshake128(32 << 3, 0x1f)(empty)).toMatchObject(HEX('1E415F1C5983AFF2169217277D17BB538CD945A397DDEC541F1CE41AF2C1B74C'))
  expect(turboshake128(64 << 3, 0x1f)(empty)).toMatchObject(HEX('1E415F1C5983AFF2169217277D17BB538CD945A397DDEC541F1CE41AF2C1B74C3E8CCAE2A4DAE56C84A04C2385C03C15E8193BDF58737363321691C05462C8DF'))
  expect(turboshake128(10032 << 3, 0x1f)(empty).slice(10000)).toMatchObject(HEX('A3B9B0385900CE761F22AED548E754DA10A5242D62E8C658E3F3A923A7555607'))
  expect(turboshake128(32 << 3, 0x1f)(ptn(17 ** 0))).toMatchObject(HEX('55CEDD6F60AF7BB29A4042AE832EF3F58DB7299F893EBB9247247D856958DAA9'))
  expect(turboshake128(32 << 3, 0x1f)(ptn(17 ** 1))).toMatchObject(HEX('9C97D036A3BAC819DB70EDE0CA554EC6E4C2A1A4FFBFD9EC269CA6A111161233'))
  expect(turboshake128(32 << 3, 0x1f)(ptn(17 ** 2))).toMatchObject(HEX('96C77C279E0126F7FC07C9B07F5CDAE1E0BE60BDBE10620040E75D7223A624D2'))
  expect(turboshake128(32 << 3, 0x1f)(ptn(17 ** 3))).toMatchObject(HEX('D4976EB56BCF118520582B709F73E1D6853E001FDAF80E1B13E0D0599D5FB372'))
  expect(turboshake128(32 << 3, 0x1f)(ptn(17 ** 4))).toMatchObject(HEX('DA67C7039E98BF530CF7A37830C6664E14CBAB7F540F58403B1B82951318EE5C'))
  ...
  expect(turboshake128(32 << 3, 0x01)(HEX('FFFFFF'))).toMatchObject(HEX('BF323F940494E88EE1C540FE660BE8A0C93F43D15EC006998462FA994EED5DAB'))
  expect(turboshake128(32 << 3, 0x06)(HEX('FF'))).toMatchObject(HEX('8EC9C66465ED0D4A6C35D13506718D687A25CB05C74CCA1E42501ABD83874A67'))
  expect(turboshake128(32 << 3, 0x07)(HEX('FFFFFF'))).toMatchObject(HEX('B658576001CAD9B1E5F399A9F77723BBA05458042D68206F7252682DBA3663ED'))
  expect(turboshake128(32 << 3, 0x0b)(HEX('FFFFFFFFFFFFFF'))).toMatchObject(HEX('8DEEAA1AEC47CCEE569F659C21DFA8E112DB3CEE37B18178B2ACD805B799CC37'))
  expect(turboshake128(32 << 3, 0x30)(HEX('FF'))).toMatchObject(HEX('553122E2135E363C3292BED2C6421FA232BAB03DAA07C7D6636603286506325B'))
  expect(turboshake128(32 << 3, 0x7f)(HEX('FFFFFF'))).toMatchObject(HEX('16274CC656D44CEFD422395D0F9053BDA6D28E122ABA15C765E5AD0E6EAF26F9'))

  expect(turboshake256(64 << 3, 0x1f)(empty)).toMatchObject(HEX('367A329DAFEA871C7802EC67F905AE13C57695DC2C6663C61035F59A18F8E7DB11EDC0E12E91EA60EB6B32DF06DD7F002FBAFABB6E13EC1CC20D995547600DB0'))
  expect(turboshake256(10032 << 3, 0x1f)(empty).slice(10000)).toMatchObject(HEX('ABEFA11630C661269249742685EC082F207265DCCF2F43534E9C61BA0C9D1D75'))
  expect(turboshake256(64 << 3, 0x1f)(ptn(17 ** 0))).toMatchObject(HEX('3E1712F928F8EAF1054632B2AA0A246ED8B0C378728F60BC970410155C28820E90CC90D8A3006AA2372C5C5EA176B0682BF22BAE7467AC94F74D43D39B0482E2'))
  expect(turboshake256(64 << 3, 0x1f)(ptn(17 ** 1))).toMatchObject(HEX('B3BAB0300E6A191FBE6137939835923578794EA54843F5011090FA2F3780A9E5CB22C59D78B40A0FBFF9E672C0FBE0970BD2C845091C6044D687054DA5D8E9C7'))
  expect(turboshake256(64 << 3, 0x1f)(ptn(17 ** 2))).toMatchObject(HEX('66B810DB8E90780424C0847372FDC95710882FDE31C6DF75BEB9D4CD9305CFCAE35E7B83E8B7E6EB4B78605880116316FE2C078A09B94AD7B8213C0A738B65C0'))
  expect(turboshake256(64 << 3, 0x1f)(ptn(17 ** 3))).toMatchObject(HEX('C74EBC919A5B3B0DD1228185BA02D29EF442D69D3D4276A93EFE0BF9A16A7DC0CD4EABADAB8CD7A5EDD96695F5D360ABE09E2C6511A3EC397DA3B76B9E1674FB'))
  expect(turboshake256(64 << 3, 0x1f)(ptn(17 ** 4))).toMatchObject(HEX('02CC3A8897E6F4F6CCB6FD46631B1F5207B66C6DE9C7B55B2D1A23134A170AFDAC234EABA9A77CFF88C1F020B73724618C5687B362C430B248CD38647F848A1D'))
  ...
  expect(turboshake256(64 << 3, 0x01)(HEX('FFFFFF'))).toMatchObject(HEX('D21C6FBBF587FA2282F29AEA620175FB0257413AF78A0B1B2A87419CE031D933AE7A4D383327A8A17641A34F8A1D1003AD7DA6B72DBA84BB62FEF28F62F12424'))
  expect(turboshake256(64 << 3, 0x06)(HEX('FF'))).toMatchObject(HEX('738D7B4E37D18B7F22AD1B5313E357E3DD7D07056A26A303C433FA3533455280F4F5A7D4F700EFB437FE6D281405E07BE32A0A972E22E63ADC1B090DAEFE004B'))
  expect(turboshake256(64 << 3, 0x07)(HEX('FFFFFF'))).toMatchObject(HEX('18B3B5B7061C2E67C1753A00E6AD7ED7BA1C906CF93EFB7092EAF27FBEEBB755AE6E292493C110E48D260028492B8E09B5500612B8F2578985DED5357D00EC67'))
  expect(turboshake256(64 << 3, 0x0b)(HEX('FFFFFFFFFFFFFF'))).toMatchObject(HEX('BB36764951EC97E9D85F7EE9A67A7718FC005CF42556BE79CE12C0BDE50E5736D6632B0D0DFB202D1BBB8FFE3DD74CB00834FA756CB03471BAB13A1E2C16B3C0'))
  expect(turboshake256(64 << 3, 0x30)(HEX('FF'))).toMatchObject(HEX('F3FE12873D34BCBB2E608779D6B70E7F86BEC7E90BF113CBD4FDD0C4E2F4625E148DD7EE1A52776CF77F240514D9CCFC3B5DDAB8EE255E39EE389072962C111A'))
  expect(turboshake256(64 << 3, 0x7f)(HEX('FFFFFF'))).toMatchObject(HEX('ABE569C1F77EC340F02705E7D37C9AB7E155516E4A6A150021D70B6FAC0BB40C069F9A9828A0D575CD99F9BAE435AB1ACF7ED9110BA97CE0388D074BAC768776'))
})
// * kangarooTwelve
it('kt12', async () => {
  // Vector Source: https://datatracker.ietf.org/doc/draft-irtf-cfrg-kangarootwelve/
  const empty = new Uint8Array(0)
  expect(kt128(32 << 3, empty)(empty)).toMatchObject(HEX('1AC2D450FC3B4205D19DA7BFCA1B37513C0803577AC7167F06FE2CE1F0EF39E5'))
  expect(kt128(64 << 3, empty)(empty)).toMatchObject(HEX('1AC2D450FC3B4205D19DA7BFCA1B37513C0803577AC7167F06FE2CE1F0EF39E54269C056B8C82E48276038B6D292966CC07A3D4645272E31FF38508139EB0A71'))
  expect(kt128(10032 << 3, empty)(empty).slice(10000)).toMatchObject(HEX('E8DC563642F7228C84684C898405D3A834799158C079B12880277A1D28E2FF6D'))
  expect(kt128(32 << 3, empty)(ptn(1))).toMatchObject(HEX('2BDA92450E8B147F8A7CB629E784A058EFCA7CF7D8218E02D345DFAA65244A1F'))
  expect(kt128(32 << 3, empty)(ptn(17))).toMatchObject(HEX('6BF75FA2239198DB4772E36478F8E19B0F371205F6A9A93A273F51DF37122888'))
  expect(kt128(32 << 3, empty)(ptn(17 ** 2))).toMatchObject(HEX('0C315EBCDEDBF61426DE7DCF8FB725D1E74675D7F5327A5067F367B108ECB67C'))
  expect(kt128(32 << 3, empty)(ptn(17 ** 3))).toMatchObject(HEX('CB552E2EC77D9910701D578B457DDF772C12E322E4EE7FE417F92C758F0D59D0'))
  expect(kt128(32 << 3, empty)(ptn(17 ** 4))).toMatchObject(HEX('8701045E22205345FF4DDA05555CBB5C3AF1A771C2B89BAEF37DB43D9998B9FE'))
  ...
  expect(kt128(32 << 3, ptn(1))(empty)).toMatchObject(HEX('FAB658DB63E94A246188BF7AF69A133045F46EE984C56E3C3328CAAF1AA1A583'))
  expect(kt128(32 << 3, ptn(41))(HEX('FF'))).toMatchObject(HEX('D848C5068CED736F4462159B9867FD4C20B808ACC3D5BC48E0B06BA0A3762EC4'))
  expect(kt128(32 << 3, ptn(41 ** 2))(HEX('FFFFFF'))).toMatchObject(HEX('C389E5009AE57120854C2E8C64670AC01358CF4C1BAF89447A724234DC7CED74'))
  expect(kt128(32 << 3, ptn(41 ** 3))(HEX('FFFFFFFFFFFFFF'))).toMatchObject(HEX('75D2F86A2E644566726B4FBCFC5657B9DBCF070C7B0DCA06450AB291D7443BCF'))
  expect(kt128(32 << 3, empty)(ptn(8191))).toMatchObject(HEX('1B577636F723643E990CC7D6A659837436FD6A103626600EB8301CD1DBE553D6'))
  expect(kt128(32 << 3, empty)(ptn(8192))).toMatchObject(HEX('48F256F6772F9EDFB6A8B661EC92DC93B95EBD05A08A17B39AE3490870C926C3'))
  expect(kt128(32 << 3, ptn(8189))(ptn(8192))).toMatchObject(HEX('3ED12F70FB05DDB58689510AB3E4D23C6C6033849AA01E1D8C220A297FEDCD0B'))
  expect(kt128(32 << 3, ptn(8190))(ptn(8192))).toMatchObject(HEX('6A7C1B6A5CD0D8C9CA943A4A216CC64604559A2EA45F78570A15253D67BA00AE'))

  expect(kt256(64 << 3, empty)(empty)).toMatchObject(HEX('B23D2E9CEA9F4904E02BEC06817FC10CE38CE8E93EF4C89E6537076AF8646404E3E8B68107B8833A5D30490AA33482353FD4ADC7148ECB782855003AAEBDE4A9'))
  expect(kt256(128 << 3, empty)(empty)).toMatchObject(
    HEX(
  ...
  expect(kt256(10064 << 3, empty)(empty).slice(10000)).toMatchObject(HEX('AD4A1D718CF950506709A4C33396139B4449041FC79A05D68DA35F1E453522E056C64FE94958E7085F2964888259B9932752F3CCD855288EFEE5FCBB8B563069'))
  expect(kt256(64 << 3, empty)(ptn(1))).toMatchObject(HEX('0D005A194085360217128CF17F91E1F71314EFA5564539D444912E3437EFA17F82DB6F6FFE76E781EAA068BCE01F2BBF81EACB983D7230F2FB02834A21B1DDD0'))
  expect(kt256(64 << 3, empty)(ptn(17))).toMatchObject(HEX('1BA3C02B1FC514474F06C8979978A9056C8483F4A1B63D0DCCEFE3A28A2F323E1CDCCA40EBF006AC76EF0397152346837B1277D3E7FAA9C9653B19075098527B'))
  expect(kt256(64 << 3, empty)(ptn(17 ** 2))).toMatchObject(HEX('DE8CCBC63E0F133EBB4416814D4C66F691BBF8B6A61EC0A7700F836B086CB029D54F12AC7159472C72DB118C35B4E6AA213C6562CAAA9DCC518959E69B10F3BA'))
  expect(kt256(64 << 3, empty)(ptn(17 ** 3))).toMatchObject(HEX('647EFB49FE9D717500171B41E7F11BD491544443209997CE1C2530D15EB1FFBB598935EF954528FFC152B1E4D731EE2683680674365CD191D562BAE753B84AA5'))
  expect(kt256(64 << 3, empty)(ptn(17 ** 4))).toMatchObject(HEX('B06275D284CD1CF205BCBE57DCCD3EC1FF6686E3ED15776383E1F2FA3C6AC8F08BF8A162829DB1A44B2A43FF83DD89C3CF1CEB61EDE659766D5CCF817A62BA8D'))
  ...
  expect(kt256(64 << 3, ptn(1))(empty)).toMatchObject(HEX('9280F5CC39B54A5A594EC63DE0BB99371E4609D44BF845C2F5B8C316D72B159811F748F23E3FABBE5C3226EC96C62186DF2D33E9DF74C5069CEECBB4DD10EFF6'))
  expect(kt256(64 << 3, ptn(41))(HEX('FF'))).toMatchObject(HEX('47EF96DD616F200937AA7847E34EC2FEAE8087E3761DC0F8C1A154F51DC9CCF845D7ADBCE57FF64B639722C6A1672E3BF5372D87E00AFF89BE97240756998853'))
  expect(kt256(64 << 3, ptn(41 ** 2))(HEX('FFFFFF'))).toMatchObject(HEX('3B48667A5051C5966C53C5D42B95DE451E05584E7806E2FB765EDA959074172CB438A9E91DDE337C98E9C41BED94C4E0AEF431D0B64EF2324F7932CAA6F54969'))
  expect(kt256(64 << 3, ptn(41 ** 3))(HEX('FFFFFFFFFFFFFF'))).toMatchObject(HEX('E0911CC00025E1540831E266D94ADD9B98712142B80D2629E643AAC4EFAF5A3A30A88CBF4AC2A91A2432743054FBCC9897670E86BA8CEC2FC2ACE9C966369724'))
  expect(kt256(64 << 3, empty)(ptn(8191))).toMatchObject(HEX('3081434D93A4108D8D8A3305B89682CEBEDC7CA4EA8A3CE869FBB73CBE4A58EEF6F24DE38FFC170514C70E7AB2D01F03812616E863D769AFB3753193BA045B20'))
  expect(kt256(64 << 3, empty)(ptn(8192))).toMatchObject(HEX('C6EE8E2AD3200C018AC87AAA031CDAC22121B412D07DC6E0DCCBB53423747E9A1C18834D99DF596CF0CF4B8DFAFB7BF02D139D0C9035725ADC1A01B7230A41FA'))
  expect(kt256(64 << 3, ptn(8189))(ptn(8192))).toMatchObject(HEX('74E47879F10A9C5D11BD2DA7E194FE57E86378BF3C3F7448EFF3C576A0F18C5CAAE0999979512090A7F348AF4260D4DE3C37F1ECAF8D2C2C96C1D16C64B12496'))
  expect(kt256(64 << 3, ptn(8190))(ptn(8192))).toMatchObject(HEX('F4B5908B929FFE01E0F79EC2F21243D41A396B2E7303A6AF1D6399CD6C7A0A2DD7C4F607E8277F9C9B1CB4AB9DDC59D4B92D1FC7558441F1832C3279A4241B8B'))
})
// * TOTP
it('totp', async () => {
  ...
  expect(totp({ current: 59000, digits: 8 })(S0)).toMatchInlineSnapshot('"94287082"')
  expect(totp({ current: 59000, digits: 8, mac: hmac(sha256) })(S1)).toMatchInlineSnapshot('"46119246"')
  expect(totp({ current: 59000, digits: 8, mac: hmac(sha512) })(S2)).toMatchInlineSnapshot('"90693936"')

  expect(totp({ current: 1111111109000, digits: 8 })(S0)).toMatchInlineSnapshot('"07081804"')
  expect(totp({ current: 1111111109000, digits: 8, mac: hmac(sha256) })(S1)).toMatchInlineSnapshot('"68084774"')
  expect(totp({ current: 1111111109000, digits: 8, mac: hmac(sha512) })(S2)).toMatchInlineSnapshot('"25091201"')

  expect(totp({ current: 20000000000000, digits: 8 })(S0)).toMatchInlineSnapshot('"65353130"')
  expect(totp({ current: 20000000000000, digits: 8, mac: hmac(sha256) })(S1)).toMatchInlineSnapshot('"77737706"')
  expect(totp({ current: 20000000000000, digits: 8, mac: hmac(sha512) })(S2)).toMatchInlineSnapshot('"47863826"')
})
