import { KitError, UTF8, joinBuffer } from '../core/utils.js'
import type { Hash, KeyHash } from '../core/hash.js'
import { createHash, createKeyHash, createTupleHash } from '../core/hash.js'
import type { Sha3Padding } from './sha3.js'
import { Keccak_c, shake128, shake256 } from './sha3.js'
...
export function parallelhash128(b: number, d: number, S: Uint8Array = new Uint8Array()) {
  return createHash(
    parallelhash(b, d, S, 256, 168, false, shake128(256)),
    {
...
export function parallelhash256(b: number, d: number, S: Uint8Array = new Uint8Array()) {
  return createHash(
    parallelhash(b, d, S, 512, 136, false, shake256(512)),
    {
...
export function parallelhash128XOF(b: number, d: number, S: Uint8Array = new Uint8Array()) {
  return createHash(
    parallelhash(b, d, S, 256, 168, true, shake128(256)),
    {
...
export function parallelhash256XOF(b: number, d: number, S: Uint8Array = new Uint8Array()) {
  return createHash(
    parallelhash(b, d, S, 512, 136, true, shake256(512)),
    {
