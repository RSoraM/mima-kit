 ...
 */
export function pkcs1_es_oaep(key: RSAPublicKey | RSAPrivateKey, hash: Hash = sha256, mgf = mgf1(hash), label = new Uint8Array()) {
 ...
 */
export function pkcs1_ssa_pss(key: RSAPublicKey | RSAPrivateKey, hash: Hash = sha256, mgf = mgf1(hash), sLen = hash.DIGEST_SIZE) {
