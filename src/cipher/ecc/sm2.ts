...
import type { ECCBase, ECCFbKoblitz, ECCFbPseudoRandom, ECCFpMontgomery, ECCFpWeierstrass, ECKeyPair, ECPrivateKey, ECPublicKey } from './ecc'
import { ECC } from './ecc'
...
export function sm2(curve: FpWECParams | FpMECParams | FbPECParams | FbKECParams = sm2p256v1) {
  ...
  const dh: SM2DH = (KA: ECKeyPair, KX: ECKeyPair, KB: ECPublicKey, KY: ECPublicKey, ZA = new Uint8Array(), ZB = new Uint8Array()) => {
